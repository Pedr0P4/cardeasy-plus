...
public class ProjectsService {
  ...
  @Autowired
  public ProjectsService(ProjectsRepository projects, TeamsRepository teams) {
    this.projects = projects;
    this.teams = teams;
  }

  public Project create(UUID teamId, String title, String description) {
    Team team = this.teams.findById(teamId).orElseThrow(TeamNotFound::new);
  ...
  public Project update(Integer id, String title, String description) {
  ...
  public void existsById(Integer id) {
    if (!this.projects.existsById(id)) throw new TeamNotFound();
  }
